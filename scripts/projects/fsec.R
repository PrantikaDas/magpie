...
#                       "timberCities",
                        ...
                        "landscapeElements",
#                        "landSharing",
                        "landSparing", "waterSparing",
#                        "peatland",
                        "soil", "noUnderweight", "halfOverweight", "fruitsNutsVegSeeds", "pulses",
                        "processed", "waste", #"allEnvPrice",
                        "RCP19", "SSP1energy")),
            ...
            b_AgroMngmt           = list(standard = c("cc", "rcp7p0", "SSP2", "NDC", "ForestryEndo"),
                                  fsec = c("FSEC", #"landSharing",
                                  "landscapeElements", "nueMAC", "riceMAC", "livestock", "awms", "soil")),
            ...
            b_Diet                = list(standard = c("cc", "rcp7p0", "SSP2", "NDC", "ForestryEndo"),
                                  fsec = c("FSEC", #"allDietAndWaste"
                                           "noUnderweight", "halfOverweight", "fruitsNutsVegSeeds", "pulses",
                                           "processed", "waste")),
