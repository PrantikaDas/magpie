...
for (scenarioName in c(
  ...
  #  "a_DietMonogastrics", "a_DietRuminants",
  #"a_DietEmptyCals",
  ...
  #"a_Bioplastics",
  #"a_LandscapeElements","a_TimberCities",
   "a_REDDaff", "a_REDD", 
  #"a_CropRotations", "a_LandSparing", "a_WaterSparing",
  #"a_PeatlandSparing",
  #"a_SoilCarbon",
  ...
  # "b_SoilMonogastric", "b_SoilMonogastricRuminants", "b_SoilRotations", "b_MonogastricsVeggies",
